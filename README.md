...
This software lets you turn your [Qubes OS 4.2 and above](https://www.qubes-os.org/) machine into
...
This release is only intended for use with Qubes OS 4.2 and above.  Older Qubes OS releases
